========================================================================
    정적 라이브러리 : NextDXGameApp 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 NextDXGameApp 라이브러리 프로젝트를 만들었습니다.

NextDXGameApp 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


NextDXGameApp.vcxproj
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 NextDXGameApp.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
